          ...
          >
            <div className="flex flex-col items-center mb-4">
              <div className="relative w-24 h-24">
                <img
                  src={formValues?.profilePicture || formValues?.avatar}
                  alt=""
                  className="w-full h-full rounded-full object-cover transition duration-300 ease-in-out"
                />
                <label
                  htmlFor="profile-picture"
                  className="absolute bottom-0 right-0 bg-green-500 text-white p-2 cursor-pointer rounded-full hover:bg-green-600 transition duration-300"
                >
                  <input
                    type="file"
                    id="profile-picture"
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {avatars.map((avatar, index) => (
                  <img
                    ...
                    onClick={() =>
                      setFormValues((prev) => ({ ...prev, avatar: avatar }))
                    }
                  />
                ))}
              </div>
